...
class DaumNewsCrawler:
    ...
    def __init__(self, main_category, sub_category, date):
        ...
        self.data_df = pd.DataFrame(columns=[
                                    ...
                                    'title', 'content', 'writer', 'writed_at', 'news_agency', 'sentiment'])
        self.params = {}
    ...
    def crawling(self):
        ...
        for r in resp:
            ...
            "referer": sticker_url,
            'Authorization' : "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..TskOABbofPQzzygYr5UOIgWsc8UIUOzXKW_FTQOMDY4"
            }
...
if __name__ == '__main__':
    # 날짜 리스트를 가져온다.
    date_list = get_date_list('20230201', '20230202')
